...
export const metadata: Metadata = {
  title: "Q&A — Frequently Asked Questions | Apoorva Kaushal",
  description:
    "Official Q&A and knowledge base for Apoorva Kaushal — Content Creator & Social Media Manager from Hathras, Uttar Pradesh, India. Explore biography, content, services, HMorix collaboration, and hiring details.",
  keywords: [
    "Apoorva Kaushal", "Apoova", "Apoorva Kaushal Hathras", "Apoorva Kuashal Hathras",
    "Apoorva kaushal HMorix", "who is Apoorva Kaushal",
    ...
    "Apoorva Kaushal Instagram", "Apoorva Kaushal YouTube",
    "Hindi comedy creator India", "Krishna content creator",
  ],
  alternates: { canonical: "https://apoorva.hmorix.in/qna" },
  openGraph: {
    title: "Apoorva Kaushal Q&A — Knowledge & Entity Overview",
    description:
      "Official Q&A answering top search queries about Apoorva Kaushal, Hathras roots, HMorix association, content creation, and digital career.",
    url: "https://apoorva.hmorix.in/qna",
    type: "website",
  },
};
...
const qnaJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Her official handles are @apoorva__kaushal on Instagram and @_apoorva7__ on YouTube. She is active across Instagram, YouTube, X (Twitter), and Facebook.",
      },
    },
    {
      "@type": "Question",
      name: "What results has Apoorva Kaushal delivered for brands?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Apoorva Kaushal has helped brands achieve 120% engagement growth in 90 days, an average 3.4× ROAS on Meta ad campaigns, and organic reach of 2M+ impressions across social platforms.",
      },
    },
  ],
};
...
const qnaCategories = [
  {
    category: "Identity, Biography & Background",
    items: [
      {
      ...
      {
        q: "What are Apoorva Kaushal's official social media handles?",
        a: "Her official handles are @apoorva__kaushal on Instagram and @_apoorva7__ on YouTube. She maintains an active presence across Instagram, YouTube, X (Twitter), and Facebook under these verified profiles.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "What languages does Apoorva Kaushal create content in?",
        a: "Apoorva Kaushal primarily creates content in Hindi, making her highly effective for brands targeting Indian audiences across Uttar Pradesh and the broader Hindi-speaking belt.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "You can choose from Starter (₹15K/mo), Growth (₹35K/mo), or Premium (₹65K/mo) management packages at apoorva.hmorix.in/hire, or submit a custom project enquiry via the contact page.",
      },
      {
      ...
      {
        q: "What results has Apoorva Kaushal achieved for clients?",
        a: "Apoorva Kaushal has delivered 120% engagement growth in 90 days for a fashion client, 3.2× ROAS for an e-commerce brand on Meta ads, and consistent 340K+ average views per Reel for organic growth campaigns.",
      },
      {
    ...
    <>
      ...
      <section className="page-hero">
        ...
        <p className="page-hero-sub">
          Direct, verified answers about Apoorva Kaushal — Hathras UP roots, HMorix collaboration, content creation, and digital management services.
        </p>
      </section>
      ...
      <section style={{ padding: "32px 48px", background: "var(--paper)", borderBottom: "1px solid var(--line)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <span className="tag">Apoova</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 14, color: "var(--muted)", lineHeight: 1.7, marginBottom: 16 }}>
              Apoorva Kaushal is an Indian creator rooted in <strong style={{ color: "var(--navy)" }}>Hathras, Uttar Pradesh</strong>. She produces high-impact digital content for brands and audiences across India — spanning Hindi comedy, parody, informative videos, and devotional Radha-Krishna storytelling.
            </p>
          ...
          <div style={{ border: "1px solid var(--line)", borderRadius: 10, overflow: "hidden", background: "var(--white)", padding: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 13 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--line)", paddingBottom: 8 }}>
                <span style={{ color: "var(--muted)" }}>Profession</span>
                <span style={{ fontWeight: 700 }}>Social Media Manager &amp; Creator</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--line)", paddingBottom: 8 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--line)", paddingBottom: 8 }}>
                <span style={{ color: "var(--muted)" }}>Total Reach</span>
                <span style={{ fontWeight: 700 }}>2M+ Organic Impressions</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "var(--muted)" }}>Official Social Handle</span>
                <span style={{ fontWeight: 700 }}>@apoorva__kaushal</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "64px 48px", background: "var(--navy)", color: "var(--white)", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <a
            href="https://wa.me/919368153189?text=Hi%20Apoorva%2C%20I%20have%20a%20question%20regarding%20your%20work!"
            className="btn"
