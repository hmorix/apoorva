      ...
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-PFF4KNZR');
          `}
        </Script>
      </head>
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PFF4KNZR"
            height="0"
            width="0"
        ...
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-CBZY5HLLYQ"
